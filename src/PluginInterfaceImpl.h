...
namespace hdt
{
	...
	public:
		...
		void onPostPostLoad();
		inline void onPreStep(const PreStepEvent& e) { m_preStepDispatcher.SendEvent(std::addressof(e)); }
		inline void onPostStep(const PostStepEvent& e) { m_postStepDispatcher.SendEvent(std::addressof(e)); }
	private:
